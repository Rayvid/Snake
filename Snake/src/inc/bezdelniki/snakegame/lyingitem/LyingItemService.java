...
public class LyingItemService implements ILyingItemService
{
	...
	@Inject
	LyingItemService(IAppSettingsService appSettingsService, ISnakeService snakeService)
	{
	...
	private boolean isWorldTileOccupied(WorldPosition position, GameWorld gameWorld)
	{
	...
	@Override
	public LyingItem createLyingItemSomewhere(ItemType itemType, GameWorld gameWorld) throws LyingItemNowhereToPlaceException
	{
