...
public class TestDeviceServiceIsolated {
	...
	public void testIfWorldPositionTransformationReturnsMeaningfullResults() throws CloneNotSupportedException
	{
		...
		DeviceCoords headCoords = deviceService.WorldCoordsToDeviceCoords(snake.headPosition);
		DeviceCoords toTheRightCoords = deviceService.WorldCoordsToDeviceCoords(toTheRight);		
		DeviceCoords toTheLeftCoords = deviceService.WorldCoordsToDeviceCoords(toTheLeft);
		...
		headCoords = deviceService.WorldCoordsToDeviceCoords(snake.headPosition);
